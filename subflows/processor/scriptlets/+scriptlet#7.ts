...
type Inputs = {
    ...
    imageConfig: { apiEndpoint: "https://ark.cn-beijing.volces.com/api/v3/images/generations"; model: "doubao-seedream-3-0-t2i-250415"; apiKey: string; format: "png"; size: "1024x1024" | "720x1280" | "1280x720" };
};
type Outputs = {
